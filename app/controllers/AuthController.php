...
class AuthController extends BaseController {
	...
	public function postLogin()
	{
		...
		try
		{
			...
			// Get the page we were before, or default to dashboard
			$redirect = Session::get('loginRedirect', URL::route('dashboard'));
	...
	public function getLogout()
	{
		...
		return Redirect::route('dashboard')->with('success', 'You have successfully logged out!');
	}
