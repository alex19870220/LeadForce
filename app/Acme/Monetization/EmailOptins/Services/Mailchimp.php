...
require_once __DIR__ . '/Mailchimp/Folders.php';
require_once __DIR__ . '/Mailchimp/Templates.php';
require_once __DIR__ . '/Mailchimp/Users.php';
require_once __DIR__ . '/Mailchimp/Helper.php';
require_once __DIR__ . '/Mailchimp/Mobile.php';
require_once __DIR__ . '/Mailchimp/Conversations.php';
require_once __DIR__ . '/Mailchimp/Ecomm.php';
require_once __DIR__ . '/Mailchimp/Neapolitan.php';
require_once __DIR__ . '/Mailchimp/Lists.php';
require_once __DIR__ . '/Mailchimp/Campaigns.php';
require_once __DIR__ . '/Mailchimp/Vip.php';
require_once __DIR__ . '/Mailchimp/Reports.php';
require_once __DIR__ . '/Mailchimp/Gallery.php';
require_once __DIR__ . '/Mailchimp/Goal.php';
require_once __DIR__ . '/Mailchimp/Exceptions.php';
...
class Mailchimp {
	...
	function __construct($apikey = null, $opts = array()) {
		if (!$apikey) {
