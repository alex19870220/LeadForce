<?php namespace Acme\Server\Cpanel;
...
class Cpanel {
	...
	*/
	...
	//This API1 function removes the specified forwarder
	...
	public function passwdpop($username, $args){
		return $this->api2_query($username, "Email", "passwdpop", $args);
	}
	//This API2 function removes the specified email.
	public function delpop($username, $args){
		return $this->api2_query($username, "Email", "delpop", $args);
	}
	//This API2 function lists emailaccounts.
	public function listpopswithdisk($username){
		return $this->api2_query($username, "Email", "listpopswithdisk");
	}

	//This API2 function add fwds to specified user@domain
	public function addforward($username, $args){
		return $this->api2_query($username, 'Email', "addforward", $args);
	}

	//This API2 function lists domain available for sending/receiving emails.
	public function listmaildomains($username){
		return $this->api2_query($username, "Email", "listmaildomains");
	}

	//This API2 function lists email forwarders on specified domain
	public function listforwards($username, $domain = null){
		return $this->api2_query($username, "Email", "listforwards");
	}
